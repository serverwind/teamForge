        ...
        <div className="my-4 sm:my-6 sm:mx-16 sm-4 sm:py-6 sm:px-2 sm:px-10">
              ...
              <div>
                ...
                <div className="sm:grid sm:grid-cols-2">
                  <div className="sm:mb-4 mb-8">
                    <p className="text-lg font-bold mb-1">Year of foundation</p>
                    <p className="text-sm">{team.year}</p>
                  </div>
                  <div className="sm:mb-4 mb-8">
                    <p className="text-lg font-bold mb-1">Conference</p>
                    <p className="text-sm">{team.conference}</p>
                  </div>
                  <div>
                    <p className="text-lg font-bold mb-1">Division</p>
                    <p className="text-sm">{team.division}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="bg-white my-4 sm:rounded border-t border-r border-l border-lightGray">
            <table className="overflow-x-auto w-full" cellPadding={8}>
              ...
              <thead>
                <tr>
                  <th colSpan={6} className="text-grey text-left font-normal border-b border-lightGray px-7 py-4">
                    Roster
                  </th>
                </tr>
              </thead>
                ...
                {players.map((player) => (
                  <tr onClick={() => navigateToPlayer(player.id)} className="border-b border-lightGray">
                    ...
                    <td className="flex gap-4 items-center">
                      <img src={player.photo} alt={player.name} className="w-12 rounded-full" />
                      <div className="flex flex-col">
                        <span className="text-grey text-sm">{player.name}</span>
                        <span className="text-lightGray text-xs">{player.position}</span>
                      </div>
                    </td>
