  ...
  return (
    <section className="bg-lightBlue sm:grid sm:grid-cols-[42%_58%] items-center justify-items-center h-screen">
      <div className="w-full bg-white h-full grid place-items-center px-5 sm:px-10">
        <form className="flex flex-col gap-6 min-w-[99%] sm:min-w-[75%]">
          <h1 className="text-darkGrey text-center sm:text-left text-4xl mb-2">Sign In</h1>
          <div className="flex flex-col gap-2">
            <label className="text-grey text-sm" htmlFor="login">
              Login
            </label>
            <input className="bg-lightestGrey1 h-10 rounded px-3 py-2 text-sm hover:bg-lightestGrey transition duration-300 focus:shadow-outline focus:outline-none" id="login" type="text" />
          </div>
          <div className="flex flex-col gap-2">
            <label className="text-grey text-sm" htmlFor="password">
              Password
            </label>
            <input className="bg-lightestGrey1 h-10 rounded px-3 py-2 text-sm  hover:bg-lightestGrey transition duration-300 focus:shadow-outline focus:outline-none" id="password" type="password" />
          </div>
